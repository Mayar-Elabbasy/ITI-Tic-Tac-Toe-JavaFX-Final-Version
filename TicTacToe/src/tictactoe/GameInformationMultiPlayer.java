  ...
  Stage secondStage;
    ...
    public GameInformationMultiPlayer() {
       ...
       gameNameLabel.setTextFill(Color.web("navy"));
        ...
        gameName .setTranslateX(385);gameName.setStyle("-fx-background-color: TRANSPARENT; -fx-border-color: navy;-fx-border-radius: 20 20 20 20;");
...
//                   AudioClip music3 =new AudioClip(this.getClass().getResource("Music.mp3").toString());
       ...
       startPlayingButton.setOnAction(new EventHandler<ActionEvent>() {
                               ...
                               public void handle(ActionEvent e) {
                                   ...
                                   MultiPlayerScene root2 = new MultiPlayerScene(gameName.getText()); 
                                   startPlayingButton.getScene().setRoot(root2.getRootPane());
                                   music3.stop();
                                       StackPane secondaryLayout = new StackPane();
              Popup popup = new Popup(); 
             
              WaitingScene root5= new  WaitingScene(); 
              popup.getContent().add(root5);
              secondaryLayout.getChildren().addAll(root5);
            
                secondStage = new Stage();
                secondStage.getIcons().add(new Image("O.png"));
                secondStage.setTitle("Waiting.........");
        ...
        Scene scene = new Scene(secondaryLayout, 700, 800); 
                  ...
                  PauseTransition delay = new PauseTransition(Duration.seconds(3));
                     delay.setOnFinished(new EventHandler<ActionEvent>()
                                   ...
                                   if (player){
                                        ...
                                        sp = new ServerPlayer (root2);
                                    }
                                        
                                    else {
                                     
                                       System.out.println("client will connect");
                                        cp = new ClientPlayer(root2); 
                                      //   secondStage.close();
