...
public  class FriendsScene extends AnchorPane {
   ...
   int winb;
    ...
    public volatile static int xoplay = 0 ; 
    ...
    public FriendsScene(String game) {
        gd.gameName=game;
        gd.insertGame();
  ...
  b0.setOnMouseClicked((MouseEvent e) -> {
     ...
     //==========iconsHandlingWhenMouseIsClicked===========
        ...
        b7.setOnMouseClicked((MouseEvent e) -> {
          ...
          //b7.setGraphic(xIconForGridButton7);
          //b7.setGraphic(oIconForGridButton7);
        });
