...
public  class GamePreferencesFriends extends AnchorPane {
    ...
    public GamePreferencesFriends() {
        ...
        startPlayingButton.setOnAction(new EventHandler<ActionEvent>() {
                               ...
                               public void handle(ActionEvent e) {
                                ...
                                {
                                   FriendsScene root2 = new FriendsScene(gameName.getText());
